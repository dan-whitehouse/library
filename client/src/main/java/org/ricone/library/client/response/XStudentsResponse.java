...
import org.ricone.library.client.response.model.XStudents;
...
public class XStudentsResponse implements XResponse<XStudents> {
	...
	public String getJSON() {
		...
		try {
			return writer.writeValueAsString(xStudents);
		}
	...
	public String getXML() {
		...
		try {
			return mapper.writeValueAsString(xStudents);
		}
		catch (JsonProcessingException e) {
			e.printStackTrace();
		}
