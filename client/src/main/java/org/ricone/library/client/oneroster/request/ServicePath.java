...
public enum ServicePath {
	...
	GET_AcademicSessions_By_SourcedId("academicSessions/{id}", ServicePathType.SINGLE,  AcademicSessionResponse.class, FieldType.AcademicSessions),
	...
	GET_Courses_By_SourcedId("courses/{id}", ServicePathType.SINGLE,  CourseResponse.class, FieldType.Courses),
	...
	GET_Classes_By_SourcedId("classes/{id}", ServicePathType.SINGLE,  ClassResponse.class, FieldType.Classes),
	...
	GET_Users_By_SourcedId("users/{id}", ServicePathType.SINGLE,  UserResponse.class, FieldType.Users),
