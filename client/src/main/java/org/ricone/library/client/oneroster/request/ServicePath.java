...
public enum ServicePath {
	...
	GET_Demographic_By_SourcedId("demographics/{id}", ServicePathType.SINGLE,  DemographicResponse.class, FieldType.Demographics),
	GET_Demographics("demographics", ServicePathType.OBJECT,  DemographicsResponse.class, FieldType.Demographics);
